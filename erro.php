...
<head>
	...
	<meta charset="UTF-8">
	<meta http-equiv="refresh" content="5;url=indexerro.html">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form name="form" onSubmit="return validar11(this);" class="login100-form validate-form" action="indexerro.html" method="POST">
					
					
					<center><img src="images/logo.png" height="50" /></br></br></center>
					<span class="login100-form-title p-b-26">
						DADOS INVALIDOS. <br><br><br>
					<center><p><font color="#fff">Confira seus dados novamente.</font></p></center><br><br>
					</span>
